    ...
    <>
      <Section className="!pb-0">
        <Container>
          ...
          <h1 className="text-h1 font-display mt-3 max-w-3xl font-bold text-text-primary">
            Transformer vos idées en solutions concrètes, mesurables et durables.
          </h1>
      ...
      <Section id="expertise">
        <Container>
          <h2 className="text-h2 font-display font-bold text-text-primary">Ce que nous faisons pour vous</h2>
          <ul className="mt-8 grid gap-4 sm:grid-cols-2">
            {expertiseAreas.map((item) => (
              <li key={item} className="text-body flex gap-3 rounded-lg border border-border-subtle bg-elevated p-5 text-text-primary">
      ...
      <Section surface id="equipe">
        <Container>
          ...
          <h2 className="text-h2 font-display mt-3 font-bold text-text-primary">L&rsquo;équipe NovatrixAI</h2>
          <div className="mt-8">
            <TeamSection />
          </div>
        </Container>
      ...
      <Section id="localisation">
        <Container>
          <h2 className="text-h2 font-display font-bold text-text-primary">Où nous trouver</h2>
          <p className="text-body-lg mt-4 max-w-xl text-text-secondary">
